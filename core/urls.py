...
urlpatterns = [
    ...
    path('download/arquivo/<int:id>',           downloadConteudo, {'tipo': 'arquivo'},          name='download-arquivos'),
    path('download/video/<int:id>',             downloadConteudo, {'tipo': 'video'},            name='download-videos'),
    path('avaliacao-curso/<int:id>',            avaliacaoCursoView,                             name='avaliacao-curso'),
    path('elimina-avaliacao/<int:id>',          eliminaAvaliacaoView,                           name='elimina-avaliacao'),
    path('atualiza-acesso-conteudo/',           atualizaAcessoConteudoView,                     name='atualiza-acesso-conteudo'),
    ...
    path('cadastros-conteudos/',                cadastroConteudosView,                          name='cadastros-conteudos-view'),
    ...
    path('remove-conteudo-curso/',           removeConteudoCursoView, name='remove-conteudo-curso'),
